...
# plt.show()
# vocab_list100 = ['1', '.', '0', '2', '의', ',', '이', '는', '다', ')', '(', '9', '년', '에', '을', '하', '3', '5', '4', '8', '은', '6', '7', ':', '를', '월', '분류', '일', '고', '-', '가', '있', '에서', '으로', '로', '한', '되', '었', '과', '들', '와', '도', '했', '적', '인', '였', '</s>', '그', '어', '기', '《', '제', '것', '*', '~', '게', '지', '"', '》', '여', '한다', '수', '역', '된', '등', '/', '며', '대', '·', '회', '선수', '영화', '대한민국', '할', '던', '해', '아', '만', '%', '명', '않', '자', '시', '에게', '중', '주', '까지', '미국', '았', '나', '번', '면', '지만', '일본', '없', '사람', '받', '성', '위', '때']
